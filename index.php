...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
 ...
 <section>
    <div class="py-4"> 
        <img src="./download.jpg" class="mx-auto d-block">
        ...
        while($user_data = mysqli_fetch_array($result)) {         
            ...
            echo "<td><a href='edit.php?id=$user_data[id]' class='btn btn-outline-warning'>Edit</a> | <a href='delete.php?id=$user_data[id]' class='btn btn-outline-primary'>Delete</a></td></tr>";        
        }
        ?>
